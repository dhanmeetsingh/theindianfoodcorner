        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center space-x-3">
              ...
              <span className="font-heading text-xl md:text-2xl font-bold tracking-wider text-text-light">
            ...
            <div className="flex items-center space-x-4">
              <a
                ...
                className="hidden lg:flex items-center space-x-2 px-6 py-2 border-2 border-secondary-gold text-secondary-gold hover:bg-secondary-gold hover:text-bg-dark transition-all duration-300 rounded-full"
              >
                <svg 
                  className="w-5 h-5" 
                  fill="currentColor" 
          ...
          >
            ...
            >
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => setIsMobileMenuOpen(false)}
                className="mt-8 px-8 py-3 bg-secondary-gold text-bg-dark rounded-full text-lg flex items-center space-x-2"
              >
                <svg 
                  className="w-6 h-6" 
                  fill="currentColor" 
