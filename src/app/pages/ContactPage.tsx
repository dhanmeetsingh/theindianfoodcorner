...
export default function ContactPage() {
  ...
  const whatsappLink = `https://wa.me/${phoneNumber.replace(
    /\+/g,
    ""
  )}?text=Hello! I would like to inquire about your restaurant.`;
      ...
      <section className="h-96 relative flex items-center justify-center grain-texture">
        ...
        <div className="relative z-10 text-center">
          <h1 className="font-heading text-5xl md:text-6xl mb-4">
            Get In <span className="text-secondary-gold">Touch</span>
          </h1>
          ...
          >
            <div>
              ...
              <p className="text-text-muted mb-8">
                Come experience authentic Indian cuisine in the heart of
                Stuttgart
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4 p-4 bg-bg-medium rounded-xl hover:bg-bg-medium/80 transition-all">
                  ...
                  <div>
                    <p className="text-text-light font-semibold mb-1">
                      Address
                    </p>
            ...
            <div className="bg-gradient-to-br from-secondary-gold/10 to-accent-saffron/10 rounded-2xl p-6 border border-secondary-gold/20">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="font-heading text-2xl text-secondary-gold">
                  Öffnungszeiten
                </h3>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center py-2 border-b border-secondary-gold/10">
                  <span className="text-text-light font-medium">Montag</span>
                  <span className="text-text-muted">Geschlossen</span>
                </div>
                ...
                <div className="flex justify-between items-center py-2 border-b border-secondary-gold/10">
                  ...
                  <span className="text-text-muted">11:30 – 21:00</span>
                </div>
                ...
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="text-text-muted">12:00 – 21:00</span>
                </div>
              </div>
            </div>
